...
Running of this script requires the installation and loading of the following packages:
...
band_listlength <- length(unique(analysisfile_formatted$band_name)) # length of list of bands for which colors are needed
band_listlength
