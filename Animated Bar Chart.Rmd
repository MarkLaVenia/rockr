...
usethis::use_github(Best_Album_Poll_PAT)
...
```{r}
setwd("C:/Users/MarkLaVenia/GitHub/Best Album Polls")
...
bands <- read_csv("data/album_polls_final_weighted.csv")

bands_long<-gather(bands, key = "year", value = "value", 2:22)
head(bands_long)

#write_csv(bands_long,"data/bands_long.csv")

#write_csv(bands_long,"data/bands_long_final.csv")

write_csv(bands_long,"data/bands_long_final_weighted.csv")
...
bands_tidy <- read_csv("data/bands_long_final_weighted.csv")
...
animate(anim, 400, fps = 10,  width = 1200, height = 1000, 
        ...
        renderer = gifski_renderer("album_poll_final_percentage.gif"))
```
