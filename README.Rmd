...
Using the `summarise(n_distinct())` command we see that across all qualifying and final polls, the data comprise *179* polls covering *249* bands cumulatively. Constraining to final polls only, the data comprise *31* polls covering *70* bands cumulatively.
