...
This plot uses a rolling average of the `poll_percent` variable as the plotted metric, based on the *final* polls.
<p align="center"> 
...
This plot uses a rolling sum of the `album_votes` variable as the plotted metric, based on the *final* polls. 
...
This plot uses uses a rolling sum of the `album_votes` variable as the plotted metric, based on *all* polls.
<p align="center"> 
